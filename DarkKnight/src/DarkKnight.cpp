...
int main(void) {
    ...
    int width = 1073;
    int height = 600;
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, "Dark Knight", monitor, NULL);
    if (window == NULL) {
    ...
    unsigned char* data = stbi_load("src/Textures/grass_block.png", &textureWidth, &textureHeight, &nrChannels, 0);
    if (data)
    {
